export const i18n = {
  en: {
    ...
    "rule_4": "Every <strong>10 seconds</strong>, a new hint unlocks (first hint is available immediately):",
    "rule_4_1": "Landmarks & Culture Clue (At Start)",
    "rule_4_2": "Geography & Nature Clue (At 10s)",
    "rule_4_3": "History & Trivia Clue (At 20s)",
    "rule_4_4": "<strong>Thermal Mouse Pointer</strong> (At 30s)",
    ...
    "hint_2_title": "HINT 2",
    "hint_2_sub": "At 10s: Geography & Nature",
    "hint_3_title": "HINT 3",
    "hint_3_sub": "At 20s: History & Trivia",
    "hint_4_title": "HINT 4",
    "hint_4_sub": "At 30s: Thermal Cursor",
  ...
  lt: {
    ...
    "rule_4": "Kas <strong>10 sekundžių</strong> atsirakina nauja užuomina (pirmoji užuomina prieinama iškart):",
    "rule_4_1": "Žymios vietos ir kultūros užuomina (Pradžioje)",
    "rule_4_2": "Geografijos ir gamtos užuomina (Po 10s)",
    "rule_4_3": "Istorijos ir įdomybių užuomina (Po 20s)",
    "rule_4_4": "<strong>Šiluminis pelės žymeklis</strong> (Po 30s)",
    ...
    "hint_2_sub": "Po 10s: geografija ir gamta",
    "hint_3_title": "3 UŽUOMINA",
    "hint_3_sub": "Po 20s: istorija ir įdomybės",
    "hint_4_title": "4 UŽUOMINA",
    "hint_4_sub": "Po 30s: šiluminis žymeklis",
    ...
    "location_gallery": "Vietovės galerija",
